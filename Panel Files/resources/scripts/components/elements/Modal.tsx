...
const ModalContainer = styled.div<{ alignTop?: boolean }>`
    ...
    ${tw`relative flex flex-col w-full m-auto text-white`};
        ...
        >
            ...
            >
                <ModalContainer alignTop={top}>
                    ...
                    <div css={tw`bg-neutral-900 p-3 sm:p-4 md:p-6 rounded shadow-md overflow-y-scroll transition-all duration-150 text-white`}>
                        {children}
                    </div>
                </ModalContainer>
            </ModalMask>
