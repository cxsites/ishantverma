...
const ToggleContainer = styled.div`
    ...
    & > input[type="checkbox"] {
        ...
        &:checked + label {
            ${tw`bg-cyan-700 border-cyan-700 shadow-none`};
        }
    ...
    & > label {
        ${tw`mb-0 block overflow-hidden cursor-pointer bg-neutral-910 border border-neutral-910 rounded-full h-6 shadow-inner`};
