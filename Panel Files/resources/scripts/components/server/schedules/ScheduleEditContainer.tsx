...
const CronBox = ({ title, value }: { title: string; value: string }) => (
    <div css={tw`bg-neutral-900 rounded p-3`}>
...
const ActivePill = ({ active }: { active: boolean }) => (
    <span
        css={[
            ...
            active ? tw`bg-cyan-700 text-white` : tw`bg-cyan-700 text-white`,
        ]}
    >
...
export default () => {
    ...
    return (
        <PageContentBlock className="editModal" css={tw`pl-40`}>
            ...
            {!schedule || isLoading ?
                ...
                <>
                    ...
                    <div css={tw`rounded shadow`}>
                        <div css={tw`sm:flex items-center bg-neutral-905 p-3 sm:p-6 border-b-4 border-cyan-700 rounded-t`}>
                            <div css={tw`flex-1`}>
                                ...
                                <p css={tw`mt-1 text-sm text-white`}>
                                    ...
                                    <span css={tw`ml-4 pl-4 border-l-4 border-cyan-700 py-px`}>
                                        Next run at:&nbsp;
                                        {schedule.nextRunAt ?
